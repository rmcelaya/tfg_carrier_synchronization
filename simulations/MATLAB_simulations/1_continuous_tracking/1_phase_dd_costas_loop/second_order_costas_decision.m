function [SER,BER] = second_order_costas_decision(EbN0,fc,Rb,plotear,save_data,N,doppler,offset_phase,variation,initial_phase,gamma,ro)
%% Docs
...
if plotear == true
    ...
    plot(ones(1,N_s+2)*(mean(phase_o))/pi);
    legend("Estimate of the phase","True offset","Estimated mean offset");
end
